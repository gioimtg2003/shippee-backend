...
export class Migration1734709829797 implements MigrationInterface {
  name = 'Migration1734709829797';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_status_history_status_enum" AS ENUM('PENDING', 'PENDING_PICKUP', 'PICKED_UP', 'COMPLETED', 'RETURN', 'RETURNING', 'RETURNED', 'CANCELED', 'RELEASE', 'ARRIVED_AT_PICKUP')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_currentstatus_enum" AS ENUM('PENDING', 'PENDING_PICKUP', 'PICKED_UP', 'COMPLETED', 'RETURN', 'RETURNING', 'RETURNED', 'CANCELED', 'RELEASE', 'ARRIVED_AT_PICKUP')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."orders_currentstatus_enum_old" AS ENUM('PENDING', 'PENDING_PICKUP', 'PICKED_UP', 'COMPLETED', 'RETURN', 'RETURNING', 'RETURNED', 'CANCELED', 'RELEASE')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ALTER COLUMN "currentStatus" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_status_history_status_enum_old" AS ENUM('PENDING', 'PENDING_PICKUP', 'PICKED_UP', 'COMPLETED', 'RETURN', 'RETURNING', 'RETURNED', 'CANCELED', 'RELEASE')`,
    );
    await queryRunner.query(
